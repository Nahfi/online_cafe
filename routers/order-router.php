...
$op = $_POST['op'];
	...
	$sql = "INSERT INTO orders (customer_id, payment_type, address,sell,total, description) VALUES ($user_id, '$payment_type', '$address',$op, $total, '$description')";
	if ($con->query($sql) === TRUE){
		...
		foreach ($_POST as $key => $value)
		{
			...
			$r=$q-$value;
			$sqlx = "UPDATE  items SET quantity=$r WHERE id=$key";
			$con->query($sqlx) === TRUE;		
