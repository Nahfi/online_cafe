...
<li>
 ...
 <form method="post" class="formValidate" id="formValidate1"  action="ofp.php">
 ...
 {  
      $output = '';  
      $sql = "SELECT date(datee) as c FROM track1 GROUP by date(datee)
";  
...
$chart_data = '';
  ...
  $sql = mysqli_query($con, "SELECT date(datee) as c FROM track1 GROUP by date(datee)
");
...
while($row = mysqli_fetch_array($sql))
          {
            ...
            $sqli = mysqli_query($con, "SELECT sum(X.quantity) as s ,x.pid,date(x.datee)as e,x.pname FROM (SELECT * FROM `track1` HAVING date(datee)='$d900')AS X GROUP by X.pid");
...
$chart_data = '';
            ...
            $sqli = mysqli_query($con, "SELECT sum(X.quantity) as s ,x.pid,date(x.datee)as e,x.pname FROM (SELECT * FROM `track1` HAVING date(datee)='$name1')AS X GROUP by X.pid
");
...
<h5> OFFLINE PRODUCT SELL CHART</h5>
