      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="emx.php" class="waves-effect waves-cyan"><i class="mdi-editor-attach-money"></i> manage employe</a>
             ...
             <li class="bold"><a href="tras.php" class="waves-effect waves-cyan"><i class="mdi-navigation-arrow-drop-down"></i> Trasaction</a>
              
            </li>

              </li>

             <li class="bold"><a href="wall.php" class="waves-effect waves-cyan"><i class="mdi-navigation-arrow-drop-down"></i>wallet</a>
