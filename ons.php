...
<li>
 ...
 <form method="post" class="formValidate" id="formValidate1"  action="ons.php">
 ...
 {  
      $output = '';  
      $sql = "SELECT DISTINCT date(date) as c FROM `orders` WHERE status='Delivered'
";  
...
$chart_data = '';
            ...
            $sqli = mysqli_query($con, "SELECT SUM(d.total)as x,d.z FROM (SELECT total, date(date) as z FROM `orders` WHERE status='Delivered')as d GROUP by d.z
...
$chart_data = '';
            ...
            $sqli = mysqli_query($con, "SELECT SUM(d.total)as x,d.z FROM (SELECT total, date(date) as z FROM `orders` WHERE status='Delivered')as d GROUP by d.z HAVING d.z='$name1'
");
...
$chart_data = '';
            ...
            $sqli = mysqli_query($con, "SELECT SUM(d.total)as x,d.z FROM (SELECT total, date(date) as z FROM `orders` WHERE status='Delivered')as d GROUP by d.z HAVING d.z BETWEEN '$name1' AND '$name2'
