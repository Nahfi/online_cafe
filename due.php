  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="details.php" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Edit Details</a>
             ...
             <li class="bold"><a href="due.php" class="waves-effect waves-cyan"><i class="mdi-editor-attach-money"></i> DUE</a>
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">User due</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">see your due here .</p>
...
$result = mysqli_query($con, "SELECT SUM(totat) as mom FROM due where uid ='$uid'");
...
$resul = mysqli_query($con, "SELECT SUM(due) as mom FROM due1 where uid ='$uid'");
...
$tow = $row['mom']; 
 ...
 ?>
  <h4 class="header">TOTAL ONLINE DUE $<?php echo $tot;?></h4>

 <li class="bold active"><a href="orders.php?status=ready" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> For online due Details</a>
            </li>  

            <h4 class="header">TOTAL OFFLINE DUE $<?php echo $tow;?></h4>
            <br>
            <br>


          <h5 class="header">PAYMENT INFO ABOUT OFFLINE DUE</h5>

     <?php 

$p="SELECT * FROM duepay WHERE sid=$uid
"; 
$stmt=$con->prepare($p);
  $stmt->execute();
  $re=$stmt->get_result();
